module.exports = {
    ...
    publicRuntimeConfig: {
        axios: {
            browserBaseURL: process.env.NODE_ENV === 'production' ? 'https://api.wndud0159.shop' : 'http://localhost:8080' //csr
        }
    },

    privateRuntimeConfig: {
        axios: {
            baseURL: process.env.NODE_ENV === 'production' ? 'https://api.wndud0159.shop' : 'http://localhost:8080' //ssr 
        }
    },
